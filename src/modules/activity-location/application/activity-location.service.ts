...
import { ActivityLocationCreationResponseDto } from '../presentation/dto/activity-location-creation-response.dto';
...
export class ActivityLocationService {
  ...
  async createActivityLocation(
  ...
  ): Promise<ActivityLocationCreationResponseDto> {
    ...
    return new ActivityLocationCreationResponseDto(activityLocation.id);
  }
